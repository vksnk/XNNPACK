#!/usr/bin/env python3
"""Baseline FP32SoftmaxDecomp masks 1..7: ynn default scheduler vs stock xnn."""
import subprocess, os, json

SP = os.path.dirname(os.path.abspath(__file__))
ROOT = os.path.expanduser("~/Projects/XNNPACK")
YNN = f"{ROOT}/bazel-bin/bench/subgraph/softmax"
XNN = os.path.join(os.path.dirname(SP), "softmax_xnn")
CPUS = "6-11"
