...
TEST_UNARY_RANGE(x86_sse2, sin, f32, 4, std::sin, 4, -1e4, 1e4);
TEST_UNARY_RANGE(x86_sse2, sin, f64, 2, std::sin, 3, -1e7, 1e7);
TEST_UNARY_RANGE(x86_sse2, cos, f32, 4, std::cos, 4, -1e4, 1e4);
TEST_UNARY_RANGE(x86_sse2, cos, f64, 2, std::cos, 3, -1e7, 1e7);
