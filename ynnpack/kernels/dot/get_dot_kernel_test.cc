...
TEST(get_dot_kernel, small_n) {
  ...
  // x86_fp32_gemv_m (tile_k=8, no wasted SIMD lanes at small n) beats the
  // n-vectorized avx2_fma3/avx512 kernels for n <= 4ish; see
  // ynnpack/kernels/dot/generator/x86_fp32_gemv_m.py.
