...
// Attention graph-construction helpers used to live here, but attention is
// still under active experimentation (multiple variants, layouts, and
// decode-specific rewrites), so it was premature to commit to one as a
// stable, reusable composite. They now live as test/benchmark-only helpers in
// ynnpack/subgraph/test/attention_graph.h -- graduate a variant back into
// this file once its API has settled.
